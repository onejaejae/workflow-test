...
### Step 0.1: 요구사항 명확화 (조건부)

입력된 Task가 모호한 경우 clarify skill을 실행하여 명확화합니다.

#### 실행 조건
clarify skill의 명확성 평가 기준(4항목 점수제)으로 **총점 2점 이상**이면 실행

#### 실행 방법
1. clarify skill 호출: `/clarify [Task]`
2. clarify skill이 반복 질문으로 요구사항 명확화
3. 명확화된 요구사항으로 Step 0.2 진행

> **참고**: 평가 기준 및 명확화 프로세스 상세는 `clarify/SKILL.md` 참조

---

### Step 0.2: Task 분석

입력된 Task(또는 명확화된 요구사항)를 분석하여 다음 항목을 도출하세요:
